package net.potatocloud.plugins.platform.neoforge.v26_1;
...
@Mod("potatocloud")
public final class NeoForge26_1Plugin implements PlatformPlugin {

    private static NeoForge26_1Plugin instance;

    private final ConnectorAPI api;
    private MinecraftServer server;
    private Service currentService;

    public NeoForge26_1Plugin() {
        instance = this;
    ...
    public static NeoForge26_1Plugin instance() {
        return instance;
    }
