...
public class DefaultProperties {
    ...
    public static final Property<Boolean> MAINTENANCE = Property.ofBoolean("maintenance", false);
    // this is for the Sign System
    public static final Property<String> SIGN_INFO = Property.ofString("sign_info", "");
    ...
    public static Set<Property<?>> asSet() {
        return Set.of(GAME_STATE, MAINTENANCE, SIGN_INFO, VELOCITY_MODERN_FORWARDING, ALWAYS_OVERRIDE_FORWARDING_SECRET);
    }
}
