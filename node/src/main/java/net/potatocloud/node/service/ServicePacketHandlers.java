...
public final class ServicePacketHandlers {
    ...
    public static void register(
        ...
        server.on(StartServicePacket.class, new StartServiceHandler(serviceManager, groupManager, clusterManager));
        server.on(StopServicePacket.class, new StopServiceHandler(serviceManager, clusterManager));
        server.on(ServiceExecuteCommandPacket.class, new ServiceExecuteCommandHandler(serviceManager, clusterManager));
        server.on(ServiceCopyPacket.class, new ServiceCopyHandler(serviceManager, clusterManager));
